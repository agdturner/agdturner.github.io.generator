...
import io.github.agdturner.course.sog.pages.SoGPythonIntroHome;
 ...
 * @author Andy Turner
 */
public abstract class SoGPythonIntroCourse extends PythonIntroCourse {
     ...
     */
    public SoGPythonIntroCourse(Environment env, String courseCode, 
        ...
        homePage = new SoGPythonIntroHome(this, courseName);
