...
public class ABM3 extends CoursePage {
     ...
     */
    public ABM3(CPPIntroCodingCourse course) {
    ...
    public String getMainContent() {
        ...
        w.addP(sb,
                ...
                returned.
                """);
        w.addP(sb, "Run the code to test it works");
        w.addP(sb,
                """
        ...
        w.addPET(sb, " to report timings and explore code efficiency.");
        w.addP(sb,
                """
        ...
        w.addP(sb,
              ...
              """);
        w.addP(sb, "Adapt your code:");
        w.addOLST(sb);
        w.addLI(sb, "Create a loop to run for a range of n_agents.");
        w.addLI(sb, "Create a list to store timing results.");
        w.addLI(sb,
                """
        ...
        w.addP(sb,
                ...
                it equal to 1000.
                """);
        w.addPST(sb, "Create a new outer ");
