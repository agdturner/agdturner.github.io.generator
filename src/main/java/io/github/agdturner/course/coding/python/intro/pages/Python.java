...
public class Python extends CoursePage {
     ...
     */
    public Python(PythonIntroCourse course) {
    ...
    public void write() {
        ...
        w.add("<p>"
                ...
                + references.getReference("Python Software Foundation")
        ...
        w.add("<p>On those webpages, changes are marked against numbered"
                ...
                + " documents providing information to the Python community, or"
        ...
        w.add("<p>Usually, a new interpreter is needed to take advantage of new"
                ...
                + " that code run with one interpreter might behave differently"
                + " or produce different results when run with another"
                + " interpreter. "
                + "Regression testing"
                + " which checks key results"
                + " are "
        ...
        w.add("<p>A "
                + index.getReference("Python ZeroDivisionError",
                        "ZeroDivisionError", sid)
                + " is an "
                + index.getReference("Python Built-in Exceptions",
                        "exception", sid)
