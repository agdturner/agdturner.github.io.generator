...
public class ABM2 extends CoursePage {
     ...
     */
    public ABM2(PythonIntroCourse course) {
    ...
    public void write() {
        ...
        sid = addSection("2", "Using Lists", 2);
        ...
        sid = addSection("4", "Using Loops", 2);
        ...
        sid = addSection("5", "More Plotting", 2);
        w.add("""
