 ...
 */
package io.github.agdturner.course.coding.intro.cpp.process;
 ...
 * @author Andy Turner
 */
public class CPP0 extends CPPIntroCodingCourse {
    
    public CPP0(Environment env, String courseCode, String courseName,
            boolean localPaths) {
    ...
    public static void main(String[] args) {
        String courseCode = "CPP0";
        String language = "C++";
        String courseName = "C++ for HPC Level 0";
        ...
        CPP0 course = new CPP0(env, courseCode, courseName, localPaths);
        course.write(local);
    }
}
