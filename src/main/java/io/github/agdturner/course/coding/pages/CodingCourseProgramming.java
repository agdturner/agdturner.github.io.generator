...
public class CodingCourseProgramming extends CoursePage {
    ...
    public void writeData() {
        SectionID sid = addSection("2", "Data", 2);
        writeDataBitsAndBytes();
        writeDataFileFormats();
        writeDataIntegersAndFloatingPoint();
    }
    
    public void writeDataBitsAndBytes() {
    ...
    public void writeDataFileFormats() {
        SectionID sid = addSection("2.2", "File Formats", 3);
    ...
    public void writeDataIntegersAndFloatingPoint() {
        SectionID sid = addSection("2.3", "Integers and Floating Point", 3);
        w.add("""
    ...
    public void writeLearning(){
        SectionID sid = addSection("3", "Learning to Program", 2);
        w.add("""
    ...
    public void writeLangaugeEvolution() {
        SectionID sid = addSection("4", "Language Evolution, Deprecation and Versions", 2);
        w.add("""
