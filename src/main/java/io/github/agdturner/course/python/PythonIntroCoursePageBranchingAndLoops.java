 ...
 * @author Andy Turner
 */
public class PythonIntroCoursePageBranchingAndLoops extends CoursePageGeneral {

    /**
     * What {@link #name} will be set to.
     */
    private static final String NAME = "branching";
     ...
     * @param c The Course.
     */
    public PythonIntroCoursePageBranchingAndLoops(PageID id, PythonIntroCourse c) {
        super(NAME, id, c);
    }
