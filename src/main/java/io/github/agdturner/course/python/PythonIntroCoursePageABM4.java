 ...
 * @author Andy Turner
 */
public class PythonIntroCoursePageABM4 extends CoursePageGeneral {

    /**
     * What {@link #name} will be set to.
     */
    private static final String NAME = "abm4";
     ...
     * @param c The Course.
     */
    public PythonIntroCoursePageABM4(PageID id, PythonIntroCourse c) {
        super(NAME, id, c);
    }
