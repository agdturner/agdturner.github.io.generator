 ...
 * @author Andy Turner
 */
public class PythonIntroCoursePageABM2 extends CoursePageGeneral {

    /**
     * What {@link #name} will be set to.
     */
    private static final String NAME = "abm2";
     ...
     * @param c The Course.
     */
    public PythonIntroCoursePageABM2(PageID id, PythonIntroCourse c) {
        super(NAME, id, c);
    }
