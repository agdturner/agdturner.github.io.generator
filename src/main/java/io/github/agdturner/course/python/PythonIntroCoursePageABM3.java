 ...
 * @author Andy Turner
 */
public class PythonIntroCoursePageABM3 extends CoursePageGeneral {

    /**
     * What {@link #name} will be set to.
     */
    private static final String NAME = "abm3";
     ...
     * @param c The Course.
     */
    public PythonIntroCoursePageABM3(PageID id, PythonIntroCourse c) {
        super(NAME, id, c);
    }
