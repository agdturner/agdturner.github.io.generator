 ...
 * @author Andy Turner
 */
public class PythonIntroCoursePageABM6 extends CoursePageGeneral {

    /**
     * What {@link #name} will be set to.
     */
    private static final String NAME = "abm6";
     ...
     * @param c The Course.
     */
    public PythonIntroCoursePageABM6(PageID id, PythonIntroCourse c) {
        super(NAME, id, c);
    }
