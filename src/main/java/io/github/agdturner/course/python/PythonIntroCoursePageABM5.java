 ...
 * @author Andy Turner
 */
public class PythonIntroCoursePageABM5 extends CoursePageGeneral {

    /**
     * What {@link #name} will be set to.
     */
    private static final String NAME = "abm5";
     ...
     * @param c The Course.
     */
    public PythonIntroCoursePageABM5(PageID id, PythonIntroCourse c) {
        super(NAME, id, c);
    }
