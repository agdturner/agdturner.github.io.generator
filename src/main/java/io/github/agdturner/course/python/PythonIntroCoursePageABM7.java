 ...
 * @author Andy Turner
 */
public class PythonIntroCoursePageABM7 extends CoursePageGeneral {

    /**
     * What {@link #name} will be set to.
     */
    private static final String NAME = "abm7";
     ...
     * @param c The Course.
     */
    public PythonIntroCoursePageABM7(PageID id, PythonIntroCourse c) {
        super(NAME, id, c);
    }
