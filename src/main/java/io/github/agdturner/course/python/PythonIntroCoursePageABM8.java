 ...
 * @author Andy Turner
 */
public class PythonIntroCoursePageABM8 extends CoursePageGeneral {

    /**
     * What {@link #name} will be set to.
     */
    private static final String NAME = "abm8";
     ...
     * @param c The Course.
     */
    public PythonIntroCoursePageABM8(PageID id, PythonIntroCourse c) {
        super(NAME, id, c);
    }
