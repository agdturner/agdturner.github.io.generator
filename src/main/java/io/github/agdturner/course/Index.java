...
public class Index extends CoursePage {
    ...
    /**
     * For checking and adding aliases. This will alias with and without
    ...
    public final void addAliasTermLowerCase(String term, IndexTerm indexTerm) {
        ...
        addAlias(term, lc, indexTerm);
        String lcExceptFirstLetter = term.substring(0,1) + lc.substring(1);        
        addAlias(term, lcExceptFirstLetter, indexTerm);
    }
    ...
    public Index(Course course, String filename, String title, String label) {
        ...
        url = Environment.getWikipediaURL("Artificial_intelligence");
        desc = """
               The capability of computational systems to perform tasks
        ...
        addIndexTerm(term, indexTerm);
        addAlias(term, "AI", indexTerm);
        
        term = "AI-assisted software development";
        url = Environment.getWikipediaURL("Alphabet_(formal_languages)");
        desc = """
               The use of artificial intelligence agents to augment the
               "software" development life cycle. It uses
               "large language models", natural language processing, and other
               AI technologies to assist "software" developers in a range of
               tasks from code generation, "refactoring", "debugging", "testing"
               and "documentation".
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTerm(term, indexTerm);
        ...
        desc = """
               A "computer program" designed to carry out a specific task other
               than one relating to the operation of the computer itself,
        ...
        desc = """
               A property of an "operating system", product, or technology that
               allows for "interoperability" with an older legacy system.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        addAlias(term, "backwards compatibility", indexTerm);
        addAlias(term, "backward compatible", indexTerm);

        term = "Bit";
        url = Environment.getWikipediaURL("Bit");
        desc = """
               A basic unit of "information" in "computing" and digital
               communications representing a logical state having one of two
               possible "values".
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTerm(term, indexTerm);
        ...
        desc = """
               A defect in the design, manufacture or operation of machinery,
        ...
        desc = """
               A form of "instruction set" designed for efficient execution by a
        ...
        desc = """
               A high-level, general-purpose "programming language". The latest
               "open standard" "C++23" was published in 2024. Previous standards
               include "C++20", "C++17", "C++14", "C++11".
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTerm(term, indexTerm);
        ...
        desc = """
               ...
               "open standard" "C23" was published in 2024. Previous standards
               include "C17", "C11", "C99", "C90".
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTerm(term, indexTerm);
        addAlias(term, "C programming language", indexTerm);
        ...
        desc = """
               ...
               the factoring - without changing its external behaviour.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        ...
        desc = """
               ...
               (See also: "Random Access Memory", "Disk")
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        addAliasAndAliasPluralAndAliasAndAliasPluralLowerCase(term, "Data storage", indexTerm);
        ...
        desc = """
               For recording "data" on a "disk", primarily identified by a
        ...
        desc = """
               A sequence of "computer" "commands" in a "programming language".
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTerm(term, indexTerm);
        addAliasTermPluralAndAliasAndAliasPluralTermLowerCase(term, indexTerm);
        ...
        desc = """
               The process of designing and building a "computer program".
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTerm(term, indexTerm);
        addAliasTermPluralAndAliasAndAliasPluralTermLowerCase(term, indexTerm);
        ...
        term = "Data structure";
        url = Environment.getWikipediaURL("Data_structure");
        desc = """
               A "data" organization, management, and storage format that is
        ...
        term = "Debugger";
        url = Environment.getWikipediaURL("Debugger");
        desc = """
               A tool for "debugging". "Software" for executing a
        ...
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        addAliasAndAliasLowerCase(term, "Debug", indexTerm);
        ...
        url = Environment.getWikipediaURL("Digital_twin");
        desc = """
               A digital "model" of a physical product, system, or process (a
        ...
        desc = """
               A "file system" cataloging structure which contains references to
        ...
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        addAliasAndAliasPluralAndAliasAndAliasPluralLowerCase(term, "Disk", indexTerm);
        addAliasAndAliasPluralAndAliasAndAliasPluralLowerCase(term, "Drive storage", indexTerm);
        ...
        desc = """
               A "computer" number format, usually occupying 64 "bits" of
               computer "memory".
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        ...
        desc = """
               A general-purpose "programming language". The latest standard is
               "Fortran 2023". Previous standards include "Fortran 2008",
               "Fortran 2003", "Fortran 95", "Fortran 90", "Fortran 77",
               "Fortran 66".
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTerm(term, indexTerm);
        ...
        desc = """
               "Software" which anyone is freely licensed to use, copy, study,
               change and share. (See also: "Free software",
        ...
        desc = """
               ...
               distribute it and any adapted versions. (See also:
        ...
        desc = """
               An open "standard" "data format" designed for representing simple
               geographical features based on the "JSON" format.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTerm(term, indexTerm);
        ...
        desc = """
               A GIS comprises people, computational resources, "software" and
               "data" to store, manage, process, analyze, and visualize
               geographical data.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTerm(term, indexTerm);
        ...
        desc = "Any kind of purposeful mark.";
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermPluralAndAliasAndAliasPluralTermLowerCase(term, indexTerm);
        ...
        desc = """
               The "XML" grammar defined by the "Open Geospatial Consortium" to
        ...
        desc = """
               ...
               "data types", "labels", "functions") in a "programming language".
               """;
        indexTerm = new IndexTerm(this, desc, url);
        ...
        desc = """
               The mechanism of basing an "object" or "class" upon another
               object ("Prototype Based Programming" inheritance) or class
        ...
        desc = """
               When a "computer" system creates a new context based on a
               pre-existing model or scheme, the model is said to have been
               instantiated.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        ...
        desc = """
               An abstract model of a device that executes "instructions"
               described by that model. A "Central Processing Unit", is an
        ...
        desc = """
               The number zero, a positive "natural number", or its negative.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermPluralAndAliasAndAliasPluralTermLowerCase(term, indexTerm);
        ...
        desc = """
               A collection of "software" tools used to make writing "code" and
               developing software easier.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTerm(term, indexTerm);
        ...
        desc = """
               A shared boundary across which two or more separate components of
        ...
        desc = """
               ...
               "instructions" in "machine code" and runs them. This combines
               compiling and executing all in one step. (See also: "Compiler").
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermPluralAndAliasAndAliasPluralTermLowerCase(term, indexTerm);
        ...
        desc = """
               An international "standards" organization composed of
        ...
        desc = """
               A global system of interconnected "computer" networks that uses
               the "Internet protocol suite" ("TCP/IP") to communicate between
        ...
        url = Environment.getWikipediaURL("Internet");
        desc = """
               A capability of a product or system to work with other products
               or systems.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        ...
        desc = """
               A high-level "programming language" that is one of the core
               technologies of the "Web". All major "Web browsers" have a
               dedicated JavaScript engine to execute code on user devices.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTerm(term, indexTerm);
        addAliasLowerCase(term, indexTerm);
        ...
        desc = """
               An open "standard" data interchange format for data objects
        ...
        desc = """
               ...
               responsible for preventing and mitigating resource conflicts
        ...
        desc = """
               A sequence of "characters" that identifies a location within
               "source code".
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermPluralAndAliasAndAliasPluralTermLowerCase(term, indexTerm);
        ...
        url = Environment.getWikipediaURL("Large_language_model");
        desc = """
               A language model trained with self-supervised machine learning on
               a vast amount of text, designed for natural language processing
               tasks, especially language generation.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermPluralAndAliasAndAliasPluralTermLowerCase(term, indexTerm);
        addAliasAndAliasPlural(term, "LLM", indexTerm);

        term = "Lexical token";
        url = Environment.getWikipediaURL("Lexical_analysis#Lexical_token_and_lexical_tokenization");
        desc = """
               A token name and an optional token value. The token name is a
        ...
        desc = """
               A "product lifecycle management" policy in which a stable release
               of "software" is maintained for a longer period of time than the
               standard edition.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        ...
        desc = """
               Machine language "instructions", which for a
        ...
        desc = """
               A group of several proprietary "Unix"-like "operating systems"
               developed and marketed by the company Apple.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTerm(term, indexTerm);
        ...
        desc = """
               "File type" metadata incorporated into the file - usually at the
               start.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        ...
        desc = """
               An object of communication that could be "data", "commands" or
               "instructions".
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermPluralAndAliasAndAliasPluralTermLowerCase(term, indexTerm);
        ...
        desc = "Data that provides information about other data.";
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        ...
        desc = """
               A method in "Object Oriented Programming" is a "procedure" or
        ...
        desc = """
               ...
               families developed and marketed by the company Microsoft.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTerm(term, indexTerm);
        ...
        desc = "The association of entities with identifiers.";
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTerm(term, indexTerm);
        ...
        term = "Open standard";
        url = Environment.getWikipediaURL("Open_standard");
        desc = """
        ...
        desc = """
               ...
               based on the concept of the "procedure" call. Procedures (a type
               of "subroutine") contain a series of computational steps to be
               carried out.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        addAliasAndAliasLowerCase(term, "Procedure", indexTerm);
        ...
        term = "QGIS";
        url = Environment.getWikipediaURL("QGIS");
        desc = """
        ...
        desc = """
               A number that can be expressed as the quotient or fraction ⁠ p/q
               of two "integers", a numerator p and a nonzero denominator q.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addAliasAndAliasPluralAndAliasAndAliasPluralLowerCase(term, "Fraction", indexTerm);
        addIndexTermAndAliasTermPluralAndAliasAndAliasPluralTermLowerCase(term, indexTerm);
        
        term = "Regression test";
        url = Environment.getWikipediaURL("Regression_testing");
        desc = """
               A test to ensure that previously developed and tested  "software"
               still performs as expected after a change.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        ...
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        addAliasToIndexAndAliasLowerCase(term, "Testing", indexTerm);
        
        term = "Source code";
        url = Environment.getWikipediaURL("Source_code");
        desc = """
               Text written using a human-readable "programming language".
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        ...
        desc = """
               "Computer hardware" that provides input and output of audio
               signals to and from a computer under the control of
               "computer programs".
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        ...
        desc = """
               A "primitive data type" whose instances have a human-readable
               form.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermPluralAndAliasAndAliasPluralTermLowerCase(term, indexTerm);
        ...
        desc = """
               The rules that define the combinations of symbols that are
               considered to be correctly structured "statements" or
        ...
        desc = """
               An error in the "syntax" of a sequence of characters or tokens
               that is intended to be written in a particular
        ...
        desc = """
               A sequence of programmed "commands" that can be managed
        ...
        desc = """
               An "information" technology "standard" for the consistent
        ...
        desc = """
               Uniform Resource Locator - a reference to a "Web" resource that
               specifies its location and the "protocol" for retrieving it.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTerm(term, indexTerm);
        ...
        desc = """
               The representation of some entity that can be manipulated by a
               "program".
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermPluralAndAliasAndAliasPluralTermLowerCase(term, indexTerm);
        ...
        desc = """
               A named container for a particular set of "bits" or type of
               "data".
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermPluralAndAliasAndAliasPluralTermLowerCase(term, indexTerm);
        ...
        term = "Vibe Programming";
        url = Environment.getWikipediaURL("Vibe_programming");
        desc = """
               An "AI-assisted software development" technique).
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermPluralAndAliasAndAliasPluralTermLowerCase(term, indexTerm);
        addAliasAndAliasPluralAndAliasAndAliasPluralLowerCase(term, "Vibe Coding", indexTerm);
        ...
        desc = """
               The inclusive practice of ensuring content and information on the
               "Web" is accessible.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        ...
        desc = """
               The quality of a clause, word, or other linguistic element that
               conforms to the grammar of the language of which it is a part.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermLowerCase(term, indexTerm);
        ...
        desc = """
               A bypass of a recognized problem or limitation in a system or
               policy.
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTermAndAliasTermPluralAndAliasAndAliasPluralTermLowerCase(term, indexTerm);
        ...
        desc = """
               An extensible markup language "standard" and "data format" for
               storing, transmitting, and reconstructing "data".
               """;
        indexTerm = new IndexTerm(this, desc, url);
        addIndexTerm(term, indexTerm);
    }
